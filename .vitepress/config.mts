    ...
    sidebar: [
      {
        ...
        items: [
          ...
          { text: '街机音游介绍', link: '/wiki/not_found' },
          { text: '移动端音游介绍', link: '/wiki/rhythm_present_mobile' },
          { text: 'PC端音游介绍', link: '/wiki/not_found' },
          { text: '音游梗百科', link: '/wiki/not_found' },
          { text: '曲师介绍', link: '/wiki/not_found' },
          { text: '收录曲介绍', link: '/wiki/not_found' },
        ]
      }
    ],
