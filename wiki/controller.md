...
7、完成八个后即可上轮子，首先将黑色螺柱拧到轮子上，再整体拧进底部铝合金柱子孔里
...
登录32寸手台配置网站：https://config.handevice.com/WebSerial/chuni32
...
手台air对应键盘按键，所以可以打开一个记事本往里面打字来测试手台，无需打开游戏。

Air按键手抬起触发的时候应该连续打出空格和数字，放下后立刻停止。

也可以使用键盘测试软件测试手台键位，更加直观。

32k模式下键位如下图。

| q    | z    | s    | e    | c    | f    | t    | b    | h    | u    | m    | k    | o    | .    | ;    | [    |
| ---- | ---- | ---- | ---- | ---- | ---- | ---- | ---- | ---- | ---- | ---- | ---- | ---- | ---- | ---- | ---- |
| a    | w    | x    | d    | r    | v    | g    | y    | n    | j    | i    | ,    | l    | p    | /    | ‘    |
...
台子本体\*1、侧边按键\*2、侧边按键连接线\*2、摇杆头\*1、Aime兼容卡\*1(编者购买后发现未有兼容卡)
...
使用附赠的螺丝刀拧开底部的螺丝，打开手台内部，按照三明治类型将按键安装好，然后安装侧键微动
